...
st.markdown('<p class="sub-title">시장 데이터를 실시간으로 분석하고</p>', unsafe_allow_html=True)
st.markdown('<p class="sub-title">전략적으로 매수를 돕는 AI 트레이딩 플랫폼</p>', unsafe_allow_html=True)
